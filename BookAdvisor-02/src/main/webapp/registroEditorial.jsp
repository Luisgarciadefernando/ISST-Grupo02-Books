...
<html lang="en">
    <head>
        ...
        <title>BookAdvisor - RegistroEditorial</title>
    ...
    %>
        ...
        <div id="div-login">
            <div class="templatemo-container">
              <div class="wrapper">
                    <form class="form-signin" action="<%=blobstoreService.createUploadUrl("/registroEditorial")%>" method="post" enctype="multipart/form-data"  style="background-color: black;opacity: 0.9;margin-bottom: pad;padding-bottom: 20px;border-radius: 5px;">     
